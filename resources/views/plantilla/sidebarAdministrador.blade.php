<nav class="menu" id="sidebar-wrapper">
  ...
  <div class="list-group">
    ...
    <div>
      <a href="#" class="d-flex list-group-item list-group-item-action border-0 link-menu bg-link">          
        <i class="bx bxs-vector bx-sm mx-3"></i> 
      ...
      <ul>
        <li>
          <a href="#" @click="menu=14" class="list-group-item list-group-item-action border-0 link-menu">          
            <i class="bx bx-calendar-edit bx-sm mx-3"></i> <span>Periodo</span> 
          </a>
        </li>
        <li>
          <a href="#" @click="menu=15" class="list-group-item list-group-item-action border-0 link-menu">          
            <i class="bx bx-area bx-sm mx-3"></i> <span>Zonas</span> 
          </a>
        </li>
        <li>
          <a href="#" @click="menu=16" class="list-group-item list-group-item-action border-0 link-menu">          
            <i class="bx bx-intersect bx-sm mx-3"></i> <span>Régimen inmuebles</span> 
          </a>
        </li>          
      </ul> 
    </div>
      ...
      <ul>
        ...
        <li>
          <a href="#" @click="menu=18" class="list-group-item list-group-item-action border-0 link-menu">          
            <i class="bx bxl-react bx-sm mx-3"></i> <span>Bitácora</span> 
          </a>
        </li>                  
      </ul>
    </div>  
