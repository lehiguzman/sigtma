	...
	<div class="shadow-container">
		<div class="card-body">       
            <div class="card-header">                    
                <h4 class="card-text">Reporte de pagos por usuario</h4>
            </div>     
        </div>
...
////////////////////////* Registro de contribuyente de actividad económica *////////////////////////////////////////
            ...
            generarPdf() {
                ...
                window.open('http://127.0.0.1:8000/reportePagos?user_id=' + me.user_id + '&fecha_desde=' + me.fecha_desde + '&fecha_hasta=' + me.fecha_hasta+ '&accion=imprimir','_blank');
            },
            ...
            generarReporte( accion ) {
                ...
                var url = '/reportePagos?user_id=' + me.user_id + '&fecha_desde=' + me.fecha_desde + '&fecha_hasta=' + me.fecha_hasta+ '&accion=generar';
